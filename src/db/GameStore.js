...
class GameStore {
  ...
  static serializeGame(game) {
    return {
      ...
      selectedDanCount: game.selectedDanCount ?? null,
      selectedSoiCount: game.selectedSoiCount ?? null,
  ...
  static deserializeGame(data) {
    return {
      ...
      selectedDanCount: data.selectedDanCount ?? null,
      selectedSoiCount: data.selectedSoiCount ?? null,
